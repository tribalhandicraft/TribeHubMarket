...
export const TRANSLATIONS: Translation = {
  ...
  fillFieldsErr: { en: "Please fill all required fields and confirm the order.", hi: "कृपया सभी आवश्यक फ़ील्ड भरें और ऑर्डर की पुष्टि करें।", mr: "कृपया सर्व आवश्यक फील्ड भरा और ऑर्डरची पुष्टी करा." },
  ...
  teamMemberRole: { en: "Team Member", hi: "टीम का सदस्य", mr: "टीम सदस्य" },
  teamMemberDesc: { en: "Staff login for internal operations", hi: "आंतरिक कार्यों के लिए स्टाफ लॉगिन", mr: "अंतर्गत कार्यांसाठी कर्मचारी लॉगिन" },
  ...
  registerTeam: { en: "Register Team Member", hi: "टीम सदस्य पंजीकृत करें", mr: "टीम सदस्य नोंदणी करा" },
  accountPending: { en: "Account pending approval from Admin.", hi: "खाता एडमिन से अनुमोदन के लिए लंबित है।", mr: "खाते प्रशासकाकडून मंजूरीसाठी प्रलंबित आहे." },
  loginSuccess: { en: "Login Successful", hi: "लॉगिन सफल", mr: "लॉगिन यशस्वी" },
  invalidCredentials: { en: "Invalid username or password", hi: "अमान्य उपयोगकर्ता नाम या पासवर्ड", mr: "अवैध वापरकर्तानाव किंवा पासवर्ड" },
  ...
  teamManagement: { en: "Team Management", hi: "टीम प्रबंधन", mr: "टीम व्यवस्थापन" },
  pendingApprovals: { en: "Pending Approvals", hi: "लंबित स्वीकृतियां", mr: "प्रलंबित मंजूरी" },
  approve: { en: "Approve", hi: "मंजूर", mr: "मंजूर" },
